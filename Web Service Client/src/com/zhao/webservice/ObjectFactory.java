 ...
 * generated in the com.zhao.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Say_QNAME = new QName("http://webService.zhao.com/", "say");
    private final static QName _SayResponse_QNAME = new QName("http://webService.zhao.com/", "sayResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.zhao.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.zhao.com/", name = "say")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webService.zhao.com/", name = "sayResponse")
